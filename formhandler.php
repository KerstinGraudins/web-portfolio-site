...
$body ="Here is the comments from your web site!:\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: kgraud01@seattlecentral.edu' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Thanks for your comments!'; // if your client has more than one web site, you can put the site name here.
...
mail ('kgraud01@seattlecentral.edu', $subject, $body, $from);
